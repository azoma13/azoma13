...
<div id="About Me" align="left">
  ...
  Я студент 2 курса магистратуры УГНТУ. Учусь по направлению "Автоматизация технологических процессов и производств". Мне нравится создавать что-то новое и полезное для общества. Раньше я занимался разработкой программного обеспечения для АСУ ТП. Было круто видеть то, что ты разрабатывал с командой, управляет целым производством. Сейчас хочу попробовать себя в разработке на Go. Отучился на курсе "Go-разработчик с нуля" от Яндекс Практикума. Активно изучаю язык программирования Golang и смежные к нему технологии.
